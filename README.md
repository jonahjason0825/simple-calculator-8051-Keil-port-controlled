...
The choice of the user is stored in port 1. The operands op1 and op2 are stored in ports 2 and 3 respectively.
The result of the operation can be viewed from port 1.
Simple exception handling is also included in this code.
Programmed and tested on Keil Microvision 5.
